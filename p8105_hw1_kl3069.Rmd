...
* Some descriptions about the penguins dataset
  ...
  + When we compare the mean and median for each variables, for _bill length_ the mean is **`r round(mean(pull(penguins, bill_length_mm), na.rm = TRUE))`**mm and the median is **`r round(median(pull(penguins, bill_length_mm), na.rm = TRUE))`**mm; for _bill depth_ the mean is **`r round(mean(pull(penguins, bill_depth_mm), na.rm = TRUE))`**mm and the median is **`r round(median(pull(penguins, bill_depth_mm), na.rm = TRUE))`**mm; for _flipper length_ the mean is **`r round(mean(pull(penguins, flipper_length_mm), na.rm = TRUE))`**mm and the median is **`r round(median(pull(penguins, flipper_length_mm), na.rm = TRUE))`**mm; for body mass the mean is **`r round(mean(pull(penguins, body_mass_g), na.rm = TRUE))`**g and the median is **`r round(median(pull(penguins, body_mass_g), na.rm = TRUE))`**g. Since the mean and the median for all variables are close to one another, we can say that the distribution for theses variables are fairly _symmetric_ and the distribution will probably have zero _skewness_.<br/>
